        ...
        <div className='w-full h-full flex justify-center
         items-center'>
          ...
          <div className='w-[200px] mx-auto flex justify-center items-center'>
            <img className='max-h-[200px] group-hover:scale-110 
            transition duration-300' src={image} alt='' />
          </div>
        </div>
        {/* button*/}
        <div className='absolute top-6 right-11 group-hover:right-5 p-2
        flex flex-col items-center justify-center gap-y-2 opacity-0 group-hover:opacity-100 duration-300'>

          <button onClick={() => addToCart (product,id)}>
            <div className='flrx justify-center items-center text-white w-12 h-12 bg-red-600'>
